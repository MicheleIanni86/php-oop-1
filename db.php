...
$videos = [
    ...
    new Movie('shining', 'us', 3, [new Genre("Horror", "Kubrick ci sapeva fare"), new Genre("Noir", "Kubrick ci sapeva fare")], "60k", 115),
    
    new Movie('il silenzio degli innocenti', 'en', 2, [new Genre("Horror", "Il miglior Hopkins")], "110k", 145),
    
    new TVSerie('breaking bad', 'en', 5, [new Genre("azione", "Storia davvero affascinante"), new Genre("thriller", "Storia davvero affascinante")], 5, 62 ),
